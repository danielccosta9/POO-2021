...
public class CadastrarHospede extends javax.swing.JFrame {
    ...
    private CadastrarHospede hospedar = new CadastrarHospede();
    ...
    public CadastrarHospede(boolean editando, CadastrarHospede hospedar){
        initComponents();
        this.editando = editando;
        this.hospedar = hospedar;
        jLabel1.setText(String.valueOf(hospedar.getName()));
        if (editando){
            jLabel1.setFocusable(false);
        }
        jLabel2.setText(hospedar.getCpf());
        jLabel3.setText(hospedar.getEndereco());
        jLabel4.setText(hospedar.getCelular());
        jLabel5.setText(hospedar.getTelefone());
        jLabel6.setText(hospedar.getEmailContato());
    }
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Cadastrar Hospede");
